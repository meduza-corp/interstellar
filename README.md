# notice
Unfortunatly I can no longer support this project. We moved to [AppFollow](http://appfollow.io/slack) it supports App Store, Google Play and Windows Phone Store.
